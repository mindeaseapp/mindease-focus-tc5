...
class AppColors {
  ...
  // DARK (✅ ajustado)
  static const Color backgroundDark = Color(0xFF020617); // bem escuro
  static const Color surfaceDark = Color(0xFF0B1220); // ✅ superfície mais clara
  static const Color cardDark = Color(0xFF0B1220); // ✅ card visível no dark
  ...
  static const Color inputBackgroundDark = Color(0xFF0B1220); // ✅ combina com card
  ...
  static const Color focusRing = Color(0x8038BDF8);
  static const Color hover = Color(0x143B5BFF);
  static const Color pressed = Color(0x1F3B5BFF);

  // OVERLAY
  static const Color overlay = Color(0x99000000);
  static const Color scrim = Color(0x66000000);

  // ColorSchemes (mantive seu formato)
